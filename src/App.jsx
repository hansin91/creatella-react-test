...
import { loadProducts, incrementPage, sortProducts, setIsSorted } from './redux/actions'
...
function App() {
  ...
  const [sort, setSort] = useState(query.get('sortBy') ? query.get('sortBy') : '')
  ...
  const isSortingLoading = useSelector(state => state.product.isSortingLoading)
    ...
    <div className="album py-5 bg-light">
      <div className="container">
        <div className="form-group row">
          <label htmlFor="sorting" className="col-sm-1 col-form-label">Sort by</label>
          ...
          <div className="col-md-2">
            <button disabled={isSortingLoading} onClick={(e) => handleSortProducts(e)} className="btn btn-block btn-primary">Sort</button>
          </div>
        </div>
